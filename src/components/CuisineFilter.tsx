...
const CuisineFilter=({isExpanded,onExpandedClick,onChange,selectedCuisines}:Props)=>{
...
<div className="text-sm font-semibold mb-2 text-blue-700 underline" onClick={handleCuisinesReset}>
Reset Filters
</div>
</div>
...
<Label htmlFor={`cuisine_${cuisine}`} className={`flex flex-1 items-center cursor-pointer text-sm rounded-full px-4 py-2 font-semibold ${
